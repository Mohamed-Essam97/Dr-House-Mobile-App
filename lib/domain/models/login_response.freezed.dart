...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      String deviceToken,
      List<String> scope,
      @JsonKey(name: 'expiresOn') String expiresOn});
...
class _$LoginResponseImpl implements _LoginResponse {
  ...
  @override
  String toString() {
    return 'LoginResponse(user: $user, accessToken: $accessToken, refreshToken: $refreshToken, deviceToken: $deviceToken, scope: $scope, expiresOn: $expiresOn)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, user, accessToken, refreshToken,
      deviceToken, const DeepCollectionEquality().hash(_scope), expiresOn);
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
          ...
          @JsonKey(name: 'expiresOn') final String expiresOn}) =
      _$LoginResponseImpl;
