...
abstract class $LoginParamsCopyWith<$Res> {
  ...
  $Res call(
      ...
      String password,
      @JsonKey(includeIfNull: false) String? deviceToken});
}
...
class _$LoginParamsImpl implements _LoginParams {
  const _$LoginParamsImpl(
      ...
      this.password = "",
      @JsonKey(includeIfNull: false) this.deviceToken = ""});
  ...
  @override
  String toString() {
    return 'LoginParams(email: $email, password: $password, deviceToken: $deviceToken)';
  }
...
abstract class _LoginParams implements LoginParams {
  const factory _LoginParams(
          ...
          final String password,
          @JsonKey(includeIfNull: false) final String? deviceToken}) =
      _$LoginParamsImpl;
