  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(
        title: TextUtils("About Us"),
      ),
      body: RawScrollbar(
        thumbColor: UIColor.kPrimaryLight,
        trackColor: UIColor.kPrimaryLight.withOpacity(0.9),
        trackBorderColor: UIColor.kPrimaryLight.withOpacity(0.9),
